...
CREATE TABLE `wp_addons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='插件表';
...
CREATE TABLE `wp_attribute` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=794 DEFAULT CHARSET=utf8 COMMENT='模型属性表';
...
CREATE TABLE `wp_model` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=98 DEFAULT CHARSET=utf8 COMMENT='文档模型表';
